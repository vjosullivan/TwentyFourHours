...
class ForecastIOBuilderTests: XCTestCase {
    ...
    static let hoursJSON: JSONDictionary     = ["latitude": testLatitude, "hourly": [["time": 1_400_000_000, "icon": "rain", "summary": "rain", "temperature": 15.4]]]
    static let noHoursJSON: JSONDictionary   = ["latitude": testLatitude, "hourly": []]
    static let daysJSON: JSONDictionary      = ["latitude": testLatitude, "daily": [["time": 1_401_000_000, "sunrise": 1_401_007_200, "sunset": 1_401_014_400]]]
